...
export const Route = createFileRoute("/user/payslips")({
  component: UserPayslipsPage,
});
      ...
      <table className="w-full text-sm border border-slate-200">
        <thead className="bg-slate-100">
          <tr>
            ...
            <th className="text-left px-3 py-2">Payslip Month</th>
            <th className="text-left px-3 py-2">Number of Days</th>
        ...
        <tbody>
          ...
          {list.map((p) => (
            <tr key={p.id} className="border-t border-slate-100">
              <td className="px-3 py-2">{p.resourceName}</td>
