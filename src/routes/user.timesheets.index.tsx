...
function UsertimesheetsPage() {
  ...
  const ts = all.filter(
    (t) => !resourceId || t.resourceId === resourceId || t.resourceId === "177",
  );
  return (
    <PageCard
    ...
    >
      <table className="w-full text-sm border border-slate-200">
        <thead className="bg-slate-100">
          <tr>
            <th className="text-left px-3 py-2">Week Number</th>
            <th className="text-left px-3 py-2">Week End Date</th>
