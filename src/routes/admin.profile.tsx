...
export const Route = createFileRoute("/admin/profile")({ component: () => (
  <PageCard title="Admin Profile">
    <div className="grid md:grid-cols-2 gap-4 max-w-2xl">
      <div><Label>Full Name</Label><Input defaultValue="Admin" /></div>
      <div><Label>Email</Label><Input defaultValue="admin@magnificit.co.uk" /></div>
    </div>
    ...
    <div className="mt-6 flex gap-2"><Button>Save</Button><Button variant="outline">Cancel</Button></div>
  </PageCard>
)});
