    ...
    <PageCard title="My Profile">
      <form onSubmit={handleSubmit((v) => update(resource.id, v))} className="space-y-6">
        <div className="flex items-center gap-4">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white font-bold text-2xl flex items-center justify-center overflow-hidden border-2 border-slate-200">
            {resource.avatarUrl ? (
              <img src={resource.avatarUrl} alt={resource.fullName} className="w-full h-full object-cover" />
            ) : (
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <Label>Skillset / Notes</Label>
            <Textarea rows={3} {...register("skillset")} />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <Input {...register("visaExpiry")} />
            </div>
            <div>
              <Label>NI Number</Label>
              <Input {...register("niNumber")} />
            </div>
            <div>
              <Label>Citizen of</Label>
              <Input {...register("citizenOf")} />
            </div>
            <div className="md:col-span-2">
